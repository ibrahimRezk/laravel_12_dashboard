...
const setActiveColor = computed(() => {
    ...
    ? (color.value =
    "bg-gradient-to-l   from-green-900 to-green-700 hover:from-green-700 hover:to-green-500 active:bg-green-600")
    : (color.value =
    "bg-gradient-to-l   from-red-800 to-red-600 hover:from-red-800 hover:to-red-500 active:bg-red-900");
});


const ActiveMonitorcolor = ref("");
const setActiveMonitorColor = computed(() => {
    return form.active_monitoring == true
    ? (ActiveMonitorcolor.value =
              "bg-gradient-to-l   from-sky-900 to-sky-700 hover:from-sky-700 hover:to-sky-500 active:bg-sky-600")
              : (ActiveMonitorcolor.value =
              "bg-gradient-to-l   from-orange-800 to-orange-600 hover:from-orange-800 hover:to-orange-500 active:bg-orange-900");
            });
  
            
const transferColor = ref("");

const setTransferColor = computed(() => {
    return form.transfer_vacation_balance_to_next_year == true
        ? (transferColor.value =
              "bg-gradient-to-l   from-blue-900 to-blue-700 hover:from-blue-700 hover:to-blue-500 active:bg-blue-600")
        : (transferColor.value =
              "bg-gradient-to-l   from-gray-800 to-gray-600 hover:from-gray-800 hover:to-gray-500 active:bg-gray-900");
});
...
onMounted(() => {
    ...
    setActiveMonitorColor.value;
    setTransferColor.value;
});
...
const inputClass =
    "  rounded rtl:text-right ltr:text-left w-full bg-gradient-to-l from-black to-gray-800 hover:from-black hover:to-gray-900 active:bg-gray-900 focus:border-white/30 focus:shadow-outline-gray text-gray-300  shadow-md border border-white/30 text-shadow-none text-sm ";
...
<template>
    ...
    <Layout :title="title">
        ...
        <Container>
            <Card class="mx-1" no-padding>
                <table class="flex border border-gray-400/10 text-zinc-500">
                    <thead
                         class="w-full align-bottom bg-gradient-to-b"
                        :class="theadClass"
                    >
                        <div
                        ...
                        >
                            ...
                            <tr :class="trClasses">
                                ...
                                <td @click="editTab(7)" :class="tdClasses">
                                    <button
                                        class="border-transparent capitalize tracking-wider focus:outline-none transition ease-in-out duration-150 rounded focus:border-white focus:shadow-outline-gray px-2 text-white font-normal shadow-md border border-white text-shadow-none hover:scale-110 truncate"
                                        :class="color"
                                        @click="changeStatus"
                                    >
                                        <h6
                        ...
                        <tr
                            ...
                            class="flex justify-center my-2 bg-gradient-to-l via-red-800/80"
                        >
                            <Button
                                @click="submit()"
    ...
    <DialogModal :show="dialogModal" @close="closeDialogModal" maxWidth="xs">
        ...
        <template #content>
            ...
            <hr class="h-px mt-2 bg-black/50 bg-gradient-horizontal-dark" />
            <div class="flex justify-center mt-2">
                <button
                    @click="dialogModal = false"
                    type="submit"
                    class="mb-2 px-5 py-0.5 rounded-full text-white bg-gradient-to-l from-orange-800 to-orange-500 hover:from-orange-900 hover:to-orange-500 border-orange-100 duration-300 capitalize tracking-wider ease-in-out hover:scale-110 shadow-black drop-shadow-2xl shadow-2xl border text-sm"
                >
                    {{ $t("general.close") }}
                </button>
            </div>
