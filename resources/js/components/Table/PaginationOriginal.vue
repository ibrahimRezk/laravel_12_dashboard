...
<template>
    ...
    <nav aria-label="Page navigation example" class="grid w-full grid-cols-10 items-center">
        <div v-if="withAxios" />
        <div v-else class="px-5 col-span-1">
            <!-- <SelectGroup
            ...
            >
                ...
                >
                    <span v-if="link.label.includes('&')">
                        <button
                            v-if="withAxios"
                            class="page-link relative block bg-transparent px-3 py-1.5 transition-all duration-300 outline-none hover:cursor-pointer hover:bg-gray-200 hover:text-gray-800 focus:shadow-none md:hidden"
                            :class="{
                ...
                >
                    <button
                        v-if="withAxios"
                        class="page-link relative border-zinc-400 bg-transparent px-3 py-1.5 transition-all duration-300 outline-none hover:cursor-pointer hover:bg-zinc-500 hover:text-gray-800 focus:shadow-none dark:border-zinc-400/40"
                        :class="{
