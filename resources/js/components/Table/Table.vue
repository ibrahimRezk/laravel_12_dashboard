...
const dataItems = computed(() => {
    ...
    if (
        ...
        props.items &&
        'data' in props.items &&
        Array.isArray(props.items.data)
    ) {
...
<template>
    <div class="flex flex-wrap">
        <div class="w-full max-w-full flex-none">
            <div
                class="wrap-break-words flex min-w-0 flex-col border border-solid border-zinc-400/20 bg-clip-border shadow-md shadow-black"
                            ...
                            >
                                ...
                                >
                                    ...
                                    <span
                                        ...
                                        class="text-md text-wrap text-sm"
                                    >
                                        {{ $t('general.' + header.label + '') }}
                                    </span>
                                </Th>
                        ...
                        <div v-if="props.noPagination === false">
                            <div class="flex items-center justify-center py-2">
                                <Pagination
                                    ...
                                    :links="
                                        (props.items as PaginatedItems)?.meta
                                            ?.links ||
                                        (props.items as PaginatedItems)?.links
                                    "
