...
/**
* @see \App\Http\Controllers\RolesController::create
 * @see app/Http/Controllers/RolesController.php:100
 * @route '/roles/create'
 */
 ...
 * @see app/Http/Controllers/RolesController.php:113
 * @route '/roles'
 */
...
/**
* @see \App\Http\Controllers\RolesController::show
 * @see app/Http/Controllers/RolesController.php:0
 * @route '/roles/{role}'
 */
 ...
 */
    ...
    show.form = showForm
/**
* @see \App\Http\Controllers\RolesController::edit
 * @see app/Http/Controllers/RolesController.php:129
 ...
 * @see app/Http/Controllers/RolesController.php:148
 * @route '/roles/{role}'
 */
 ...
 * @see app/Http/Controllers/RolesController.php:159
 * @route '/roles/{role}'
 */
...
/**
* @see \App\Http\Controllers\AttachPermissionToRoleController::__invoke
 * @see app/Http/Controllers/AttachPermissionToRoleController.php:29
 * @route '/roles/attach-permission'
 */
export const attachPermission = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: attachPermission.url(options),
    method: 'post',
})

attachPermission.definition = {
    methods: ["post"],
    url: '/roles/attach-permission',
} satisfies RouteDefinition<["post"]>
 ...
 * @route '/roles/attach-permission'
 */
attachPermission.url = (options?: RouteQueryOptions) => {
    return attachPermission.definition.url + queryParams(options)
}
 ...
 * @route '/roles/attach-permission'
 */
attachPermission.post = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: attachPermission.url(options),
    method: 'post',
})
 ...
 * @route '/roles/attach-permission'
 */
    const attachPermissionForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: attachPermission.url(options),
        method: 'post',
    })
 ...
 * @route '/roles/attach-permission'
 */
        attachPermissionForm.post = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: attachPermission.url(options),
            method: 'post',
        })
    
    attachPermission.form = attachPermissionForm
/**
* @see \App\Http\Controllers\DetachPermissionFromRoleController::__invoke
 * @see app/Http/Controllers/DetachPermissionFromRoleController.php:23
 * @route '/roles/detach-permission'
 */
export const detachPermission = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: detachPermission.url(options),
    method: 'post',
})

detachPermission.definition = {
    methods: ["post"],
    url: '/roles/detach-permission',
} satisfies RouteDefinition<["post"]>
 ...
 * @route '/roles/detach-permission'
 */
detachPermission.url = (options?: RouteQueryOptions) => {
    return detachPermission.definition.url + queryParams(options)
}
 ...
 * @route '/roles/detach-permission'
 */
detachPermission.post = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: detachPermission.url(options),
    method: 'post',
})
 ...
 * @route '/roles/detach-permission'
 */
    const detachPermissionForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: detachPermission.url(options),
        method: 'post',
    })
 ...
 * @route '/roles/detach-permission'
 */
        detachPermissionForm.post = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: detachPermission.url(options),
            method: 'post',
        })
    
    detachPermission.form = detachPermissionForm
const roles = {
...
attachPermission: Object.assign(attachPermission, attachPermission),
detachPermission: Object.assign(detachPermission, detachPermission),
}
